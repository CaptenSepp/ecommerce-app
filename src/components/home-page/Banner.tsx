const Banner = () => {
  return (
    <div className="">
      <section className="w-full h-[20vw] bg-[url('/src/assets/images/fragrances-hero.jpg')] bg-cover max-w-">
        <div className="mx-auto w-screen max-w-screen-xl px-4 py-16">
          <div className="max-w-prose">
            ...
            <div className="mt-4 flex gap-4">
              <a
                className="inline-block rounded-lg border border-black-600 bg-amber-600 px-5 py-3 font-medium text-black shadow-sm transition-colors hover:bg-yellow-800 hover:text-white hover:border-black"
                href="#"
              >
                Get Started
              </a>
