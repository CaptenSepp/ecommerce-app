...
import { loadStoredCustomer, saveStoredCustomer } from "./checkout/checkout-tools"
    ...
    <div className="app-page-shell app-page-shell--wide">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <CheckoutForm
          ...
          initialValues={loadStoredCustomer()} // Prefill once from session data so the user does not need to retype the same checkout details every time.
